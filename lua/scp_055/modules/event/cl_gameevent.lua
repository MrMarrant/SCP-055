...
local function CreateEnnemy(gamePanel, ply, x, y, velocity, ennemies, index)
    ...
    ennemy:SetSize(gamePanel:GetWide() * 0.015, gamePanel:GetTall() * 0.03)
    ennemy:SetPos(x, y)
...
local function CreatePlayer(gamePanel, ply, x, y, color)
    ...
    ply.SCP055_player1:SetSize(gamePanel:GetWide() * 0.01, gamePanel:GetTall() * 0.02)
...
local function MainMap(gamePanel, ply)
    ...
    CreateWall(gamePanel, width * 0.02, height * 0.1, width * 0.4, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.02, height * 0.9, width * 0.458, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.02, height * 0.1, width * 0.02, height * 0.8, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.02, height * 0.3, width * 0.08, height * 0.6, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.08, height * 0.12, width * 0.0220, height * 0.08, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.08, height * 0.25, width * 0.02, height * 0.08, colorWall, ply.SCP055_walls)
    ...
    CreateWall(gamePanel, width * 0.14, height * 0.5, width * 0.15, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.14, height * 0.5, width * 0.025, height * 0.35, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.22, height * 0.57, width * 0.02, height * 0.34, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.3, height * 0.771, width * 0.14, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.458, height * 0.45, width * 0.02, height * 0.45, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.35, height * 0.68, width * 0.12, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.3, height * 0.6, width * 0.13, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.35, height * 0.45, width * 0.12, height * 0.08, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.46, height * 0.56, width * 0.7, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.46, height * 0.26, width * 0.7, height * 0.03, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.985, height * 0.28, width * 0.016, height * 0.1, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.985, height * 0.48, width * 0.016, height * 0.1, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.95, height * 0.37, width * 0.015, height * 0.2, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.95, height * 0.28, width * 0.015, 40, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.9, height * 0.33, width * 0.02, height * 0.2, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.88, height * 0.28, width * 0.06, height * 0.05, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.82, height * 0.37, width * 0.02, height * 0.2, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.82, height * 0.28, width * 0.02, height * 0.04, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.77, height * 0.53, width * 0.03, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.77, height * 0.37, width * 0.0195, height * 0.2, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.7597, height * 0.34, width * 0.03, height * 0.04, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.71, height * 0.28, width * 0.02, height * 0.2, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.66, height * 0.28, width * 0.02, height * 0.2, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.66, height * 0.36, width * 0.07, height * 0.04, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.61, height * 0.28, width * 0.02, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.61, height * 0.4, width * 0.02, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.61, height * 0.53, width * 0.02, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.63, height * 0.28, width * 0.015, height * 0.2, colorWall, ply.SCP055_walls)
    ...
    CreateWall(gamePanel, width * 0.5, height * 0.28, width * 0.03, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.5, height * 0.4, width * 0.03, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.5, height * 0.53, width * 0.03, height * 0.04, colorWall, ply.SCP055_walls)
    CreateWall(gamePanel, width * 0.515, height * 0.28, width * 0.016, height * 0.2, colorWall, ply.SCP055_walls)

    CreateWall(gamePanel, width * 0.995, height * 0.38, width * 0.01, height * 0.1, Color(0, 0, 0), ply.SCP055_walls, true)
